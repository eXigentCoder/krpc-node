...
/**
 * Takes in a value and encodes it as `bytes` stored in a [ByteBuffer]{@link https://www.npmjs.com/package/bytebuffer} object for use with the protobufjs library.
 * @param value - The value to encode.
 * @return {ByteBuffer|void}
 */
