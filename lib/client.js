 ...
 * @param {object} [options.rpc] The options used to create the web socket client for primary calls to the server
 ...
 * @param {object} [options.stream] The options used to create the web socket client for stream calls to the server
...
function buildClient(options, callback) {
     ...
     * @param {function} send Sends a call to the server see {@link send}
     */
    let client = {
        callbackStack: [],
        decodeStack: [],
