 ...
 * @param {string} options.protocol - The protocol to use to connect to the server. ws or wss.
 * @param {string} options.host - The host address of the server.
 * @param {string|number} options.port - The port number on which to connect to the server.
...
module.exports = function Client(options) {
     ...
     * @property {send} send - Sends one or more calls to the server to process
     * @property {on} on - Registers for one of the events [open, message, error, close].
     */
    let client = {
        socket: socket,
