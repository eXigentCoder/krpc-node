 ...
 * @name SpaceCenter
 * @description Provides functionality to interact with Kerbal Space Program. This includes controlling the active vessel, managing its resources, planning maneuver nodes and auto-piloting.
 * @result {void}
 * @returns {void}
*/
 ...
 * @result {Long} A long value representing the id for the SpaceCenter.WaypointManager see [Long.js]{@link https://www.npmjs.com/package/long}
 * @returns {{call :Object, decode: function}}
*/
 ...
 * @result {Long} A long value representing the id for the SpaceCenter.Camera see [Long.js]{@link https://www.npmjs.com/package/long}
 * @returns {{call :Object, decode: function}}
*/
 ...
 * @result {Long} A long value representing the id for the SpaceCenter.WarpMode see [Long.js]{@link https://www.npmjs.com/package/long}
 * @returns {{call :Object, decode: function}}
*/
...
/**
 * @augments SpaceCenter
 * @description     <c>true</c> if the body has an atmosphere.
 * @param {Long} celestialBody - A long value representing the id for the SpaceCenter.CelestialBody see [Long.js]{@link https://www.npmjs.com/package/long}
 * @result {boolean}
 * @returns {{call :Object, decode: function}}
*/
...
/**
 * @augments SpaceCenter
 * @description     <c>true</c> if there is oxygen in the atmosphere, required for air-breathing engines.
 * @param {Long} celestialBody - A long value representing the id for the SpaceCenter.CelestialBody see [Long.js]{@link https://www.npmjs.com/package/long}
 * @result {boolean}
 * @returns {{call :Object, decode: function}}
*/
...
/**
 * @augments SpaceCenter
 * @description Sets the state of the given action group (a value between 0 and 9
inclusive).
 *   <param name="state">
 *  </param>
 * @param {Long} control - A long value representing the id for the SpaceCenter.Control see [Long.js]{@link https://www.npmjs.com/package/long}
...
/**
 * @augments SpaceCenter
 * @description     <c>true</c> if the module has an event with the given name.
 *             <param name="name">
 *  </param>
 * @param {Long} module - A long value representing the id for the SpaceCenter.Module see [Long.js]{@link https://www.npmjs.com/package/long}
 * @param {string} name -
...
/**
 * @augments SpaceCenter
 * @description     <c>true</c> if the part has an action with the given name.
 *             <param name="name">
 *  </param>
 * @param {Long} module - A long value representing the id for the SpaceCenter.Module see [Long.js]{@link https://www.npmjs.com/package/long}
 * @param {string} name -
...
<list type="bullet"><item><description>The origin is at the position of the part, as returned by {@link M:SpaceCenter.Part.Position}.</description></item><item><description>The axes rotate with the part.</description></item><item><description>The x, y and z axis directions depend on the design of the part.</description></item></list> For docking port parts, this reference frame is not necessarily equivalent to the reference frame
...
<list type="bullet"><item><description>The origin is at the center of mass of the part, as returned by {@link M:SpaceCenter.Part.CenterOfMass}.</description></item><item><description>The axes rotate with the part.</description></item><item><description>The x, y and z axis directions depend on the design of the part.</description></item></list> For docking port parts, this reference frame is not necessarily equivalent to the reference frame
for the docking port, returned by {@link M:SpaceCenter.DockingPort.ReferenceFrame}.
 * @param {Long} part - A long value representing the id for the SpaceCenter.Part see [Long.js]{@link https://www.npmjs.com/package/long}
 * @result {Long} A long value representing the id for the SpaceCenter.ReferenceFrame see [Long.js]{@link https://www.npmjs.com/package/long}
 * @returns {{call :Object, decode: function}}
...
/**
 * @augments SpaceCenter
 * @description The reachable resources connected to this propellant.
 * @param {Long} propellant - A long value representing the id for the SpaceCenter.Propellant see [Long.js]{@link https://www.npmjs.com/package/long}
...
/**
 * @augments SpaceCenter
 * @description The current power usage of the sensor, in units of charge per second.
 * @param {Long} sensor - A long value representing the id for the SpaceCenter.Sensor see [Long.js]{@link https://www.npmjs.com/package/long}
 * @result {number}
 * @returns {{call :Object, decode: function}}
*/
...
This corresponds to the vessels reference frame ({@link M:SpaceCenter.Vessel.ReferenceFrame}).
 * @param {Long} vessel - A long value representing the id for the SpaceCenter.Vessel see [Long.js]{@link https://www.npmjs.com/package/long}
 * @result {{number, number, number}}
 * @returns {{call :Object, decode: function}}
*/
...
/**
 * @augments SpaceCenter
 * @description The inertia tensor of the vessel around its center of mass, in the vessels reference frame ({@link M:SpaceCenter.Vessel.ReferenceFrame}).
Returns the 3x3 matrix as a list of elements, in row-major order.
 * @param {Long} vessel - A long value representing the id for the SpaceCenter.Vessel see [Long.js]{@link https://www.npmjs.com/package/long}
 * @result {number[]}
 * @returns {{call :Object, decode: function}}
...
vessels reference frame ({@link M:SpaceCenter.Vessel.ReferenceFrame}).
