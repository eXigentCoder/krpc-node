 ...
 * @constructor UI
 * @name UI
 * @description Provides functionality for drawing and interacting with in-game user interface elements. For drawing 3D objects in the flight scene, see the Drawing service.
 * @result {void}
 * @returns {void}
*/
 ...
 * @result {Long} A long value representing the id for the UI.Canvas see [Long.js]{@link https://www.npmjs.com/package/long}
 ...
 * @param {Long} position - A long value representing the id for the UI.MessagePosition see [Long.js]{@link https://www.npmjs.com/package/long}
 * @result {void}
 * @returns {void}
*/
