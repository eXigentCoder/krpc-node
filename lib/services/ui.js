...
module.exports.message = function message(content, duration, position) {
    let encodedArguments = [
        ...
        decoders.enum({0 : 'BottomCenter', 1 : 'TopCenter', 2 : 'TopLeft', 3 : 'TopRight'})(position)
    ];
    return {
...
module.exports.textSetStyle = function textSetStyle(text, value) {
    let encodedArguments = [
        encoders.uInt64(text), 
        decoders.enum({0 : 'Normal', 1 : 'Bold', 2 : 'Italic', 3 : 'BoldAndItalic'})(value)
    ];
    return {
...
module.exports.textSetAlignment = function textSetAlignment(text, value) {
    let encodedArguments = [
        encoders.uInt64(text), 
        decoders.enum({0 : 'LowerCenter', 1 : 'LowerLeft', 2 : 'LowerRight', 3 : 'MiddleCenter', 4 : 'MiddleLeft', 5 : 'MiddleRight', 6 : 'UpperCenter', 7 : 'UpperLeft', 8 : 'UpperRight'})(value)
    ];
    return {
