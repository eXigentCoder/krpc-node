...
module.exports.alarmsWithType = function alarmsWithType(type) {
    let encodedArguments = [
        decoders.enum({0 : 'Raw', 1 : 'Maneuver', 2 : 'ManeuverAuto', 3 : 'Apoapsis', 4 : 'Periapsis', 5 : 'AscendingNode', 6 : 'DescendingNode', 7 : 'Closest', 8 : 'Contract', 9 : 'ContractAuto', 10 : 'Crew', 11 : 'Distance', 12 : 'EarthTime', 13 : 'LaunchRendevous', 14 : 'SOIChange', 15 : 'SOIChangeAuto', 16 : 'Transfer', 17 : 'TransferModelled'})(type)
    ];
    return {
...
module.exports.alarmSetAction = function alarmSetAction(alarm, value) {
    let encodedArguments = [
        encoders.uInt64(alarm), 
        decoders.enum({0 : 'DoNothing', 1 : 'DoNothingDeleteWhenPassed', 2 : 'KillWarp', 3 : 'KillWarpOnly', 4 : 'MessageOnly', 5 : 'PauseGame'})(value)
    ];
    return {
