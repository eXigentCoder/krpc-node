...
module.exports.alarmRemove = function alarmRemove(alarm) {
    let encodedArguments = [encoders.uInt64(alarm)];
    return {
...
module.exports.alarmSetMargin = function alarmSetMargin(alarm, value) {
    let encodedArguments = [encoders.uInt64(alarm), encoders.double(value)];
    return {
...
module.exports.alarmSetName = function alarmSetName(alarm, value) {
    let encodedArguments = [encoders.uInt64(alarm), encoders.string(value)];
    return {
...
module.exports.alarmSetRepeat = function alarmSetRepeat(alarm, value) {
    let encodedArguments = [encoders.uInt64(alarm), encoders.bool(value)];
    return {
...
module.exports.alarmSetVessel = function alarmSetVessel(alarm, value) {
    let encodedArguments = [encoders.uInt64(alarm), encoders.uInt64(value)];
    return {
